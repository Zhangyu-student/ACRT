...
os.environ['TORCH_HOME'] = 'C:\\Users\\Zhangyu\\torch_models'  # Windows
...
from saicinpainting.utils import handle_ddp_subprocess, handle_ddp_parent_process, \
...
@hydra.main(config_path='../configs', config_name='landsat_config.yaml')
